...
export const StarrateConcat = (args) => {
	...
	return (<div className={ToolsValues.starrate_concat.name + '_form'}>
		<div className="description">Описание: {ToolsValues.starrate_concat.desc}</div>
			<div className="input-group">

				<InOutPanel 
					panel_type='input'
					display_path_default_text='Select input first osu!.db'
					dialog_name={dialog_names.input}
					dialog_title='Select input first osu!.db'
				...
				<InOutPanel 
					panel_type='input'
					display_path_default_text='Select input second osu!.db'
					dialog_name={dialog_names.input_2}
					dialog_title='Select input second osu!.db'
					dialog_accept_ext='.db'
					button_text='select'

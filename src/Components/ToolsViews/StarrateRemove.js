...
export const StarrateRemove = (args) => {
	...
	return (<div className={ToolsValues.starrate_remove.name + '_form'}>
		<div className="description">Описание: {ToolsValues.starrate_remove.desc}</div>
